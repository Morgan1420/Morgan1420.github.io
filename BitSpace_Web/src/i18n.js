...
const messages = {
  ca: {
    ...
    waitlist_sant_jordi_desc: "Uneix-te a la nostra llista d'espera i celebra el dia de Sant Jordi amb nosaltres — històries, roses i alguna cosa nova a punt de florir.",
  ...
  es: {
    ...
    waitlist_sant_jordi_desc: 'Únete a la lista de espera y celebra el Día de Sant Jordi con nosotros — historias, rosas y algo nuevo a punto de florecer.',
  ...
  en: {
    ...
    waitlist_sant_jordi_desc: "Join the waitlist and celebrate Sant Jordi's Day with us — stories, roses, and something new in bloom.",
