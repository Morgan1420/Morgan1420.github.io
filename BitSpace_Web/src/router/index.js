...
const getPageMeta = (lang) => {
  const meta = {
    ca: {
      ...
      description: 'BitSpace és una aplicació mòbil que t\'ajuda a millorar els teus hàbits de salut cuidant una mascota digital. Millora el teu benestar mentre el teu Bit creix feliç.',
      ogTitle: 'BitSpace - Salut Digital | Cuida la teva mascota digital',
      ogDescription: 'Millora els teus hàbits de salut cuidant una mascota digital. El teu Bit actuarà com a mirall de la teva salut i benestar.'
    },
    es: {
      title: 'BitSpace - Salud Digital | Cuida tu mascota digital',
      description: 'BitSpace es una aplicación móvil que te ayuda a mejorar tus hábitos de salud cuidando una mascota digital. Mejora tu bienestar mientras tu Bit crece feliz.',
      ogTitle: 'BitSpace - Salud Digital | Cuida tu mascota digital',
      ogDescription: 'Mejora tus hábitos de salud cuidando una mascota digital. Tu Bit actuará como un espejo de tu salud y bienestar.'
    },
    en: {
      title: 'BitSpace - Digital Health | Take care of your digital pet',
      description: 'BitSpace is a mobile app that helps you improve your health habits by caring for a digital pet. Improve your wellbeing while your Bit grows happily.',
      ogTitle: 'BitSpace - Digital Health | Take care of your digital pet',
      ogDescription: 'Improve your health habits by caring for a digital pet. Your Bit acts as a mirror of your health and wellbeing.'
    }
  }
...
const router = createRouter({
  ...
  scrollBehavior(to, from, savedPosition) {
    // Siempre volver al top cuando se cambia de ruta
    if (savedPosition) {
